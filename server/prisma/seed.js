...
const PROVIDERS = [
  {
    email: 'maria.santos@mytimebooked.com', name: 'Maria Santos',
  ...
  {
    email: 'jasmine.lee@mytimebooked.com', name: 'Jasmine Lee',
  ...
  {
    email: 'diego.ramirez@mytimebooked.com', name: 'Diego Ramirez',
  ...
  {
    email: 'hannah.brooks@mytimebooked.com', name: 'Hannah Brooks',
  ...
  {
    email: 'tom.nguyen@mytimebooked.com', name: 'Tom Nguyen',
  ...
  {
    email: 'ray.thompson@mytimebooked.com', name: 'Ray Thompson',
  ...
  {
    email: 'grace.okafor@mytimebooked.com', name: 'Grace Okafor',
  ...
  {
    email: 'ethan.walker@mytimebooked.com', name: 'Ethan Walker',
